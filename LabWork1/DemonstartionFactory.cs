...
namespace LabWork1
{
    internal class DemonstartionFactory
    {
        public static void Main()
        {
            ...
            Console.WriteLine($"Название: {factory.GetName()}");
            Console.WriteLine($"Адрес: {factory.GetLocation()}");
            Console.WriteLine($"Год основания: {factory.GetEstablishedYear()}\n");
            ...
            Console.WriteLine($"{worker1.GetId()}: {worker1.GetFullName()}, {worker1.GetPosition()}, ставка {worker1.GetHourlyRate()} €/ч");
            Console.WriteLine($"{worker2.GetId()}: {worker2.GetFullName()}, {worker2.GetPosition()}, ставка {worker2.GetHourlyRate()} €/ч\n");
            ...
            var order1 = new ProductionOrder(400, "TS-ORD-001", product1.GetId(), 1200, "2026-03-01", "2026-03-07");
            ...
            var qc1 = new QualityCheck(500, order1.GetId(), product1.GetId(), "Инспектор Клаус", "PASSED", 3);
            ...
            var task1 = new MaintenanceTask(600, machine1.GetId(), "Замена режущего инструмента", "2026-03-05");
            ...
            var incident1 = new SafetyIncident(800, "2026-03-02", workshop1.GetId(), "Порез руки при резке металла", "LOW");
